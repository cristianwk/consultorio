        ...
        <div class="content-bottom">
            ...
            <div class="rsidebar span_1_of_3">
                <div class="banner-form animated fadeInUp" style="visibility: visible;">
                    ...
                    <form id="form" name="form" method="post" action="http://www.clickconsultorio.com/medico/registro">
        ...
        <div class="content-top">
            <div class="col_1_of_4 span_1_of_4">
                ...
                <div class="footer-pic">
                    ...
                    <a href="https://clickconsultorio.blogspot.com" class="link-2">Blogger</a>
                    <a href="#" class=""></a>
                    <div class="clear"></div>
                </div>
            </div>
            ...
            <div class="col_1_of_4 span_1_of_4">
                ...
                <div class="text">Nosso suporte online por Skype ou email:<br>
                    <span style="font-size: 1em">contato@clickconsultorio.com</span></div>
            </div>
            <div class="clear"></div>
        </div>
    </div>
